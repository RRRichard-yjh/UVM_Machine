...
if __name__ == '__main__':
    ...
    parser.add_argument('-prompt', default='./auto_seq/prompt_check_seq.txt', type=str, help='Path to prompt function file')#prompt
    ...
    with open(r"./auto_seq/answer2.md", "w", encoding='utf-8') as wf:
        wf.write(answer2)
    ...
    if corrected_file_marker in answer2:
        ...
        if content:
            output_file_name = f"./{uvm_testbench}/{module_name}_seq.sv"
