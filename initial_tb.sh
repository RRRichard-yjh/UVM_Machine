...
cp "./auto_interface/${module_name}_if.sv" "$uvm_testbench"
cp "./auto_seq_item/${module_name}_seq_item.sv" "$uvm_testbench"
cp "./auto_sequencer/${module_name}_sequencer.sv" "$uvm_testbench"
cp "./auto_driver/${module_name}_driver.sv" "$uvm_testbench"
cp "./auto_monitor/${module_name}_monitor.sv" "$uvm_testbench"
cp "./auto_seq/${module_name}_seq.sv" "$uvm_testbench"
cp "./auto_agent/${module_name}_agent.sv" "$uvm_testbench"
cp "./auto_scb/${module_name}_scoreboard.sv" "$uvm_testbench"
cp "./auto_env/${module_name}_env.sv" "$uvm_testbench"
cp "./auto_test/${module_name}_test.sv" "$uvm_testbench"
cp "./auto_top/${module_name}_Top.sv" "$uvm_testbench"
cp "./auto_top/${module_name}_list.f" "$uvm_testbench"
