...
if __name__ == '__main__':
    ...
    parser.add_argument('-cov_file', default='./auto_coverage/uncovered_code/line_coverage.txt', type=str, help='Path to coverage file')  # coverage
    ...
    parser.add_argument('-prompt', default='./auto_add_seq/code/line/prompt_add_line_code_seq.txt', type=str, help='Path to prompt function file')  # prompt
    ...
    with open(r"./auto_add_seq/code/line/answer1.md", "w", encoding='utf-8') as wf:
        wf.write(answer1)
    ...
    if content:
        output_file_name = f"./auto_add_seq/code/line/{module_name}_add_line_code_seq.sv"
