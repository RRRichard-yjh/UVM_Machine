...
if __name__ == '__main__':
    ...
    parser.add_argument('-cov_file', default='./auto_coverage/uncovered_code/conditional_coverage.txt', type=str, help='Path to coverage file')  # coverage
    ...
    parser.add_argument('-prompt', default='./auto_add_seq/code/cond/prompt_add_cond_code_seq.txt', type=str, help='Path to prompt function file')  # prompt
    ...
    with open(r"./auto_add_seq/code/cond/answer1.md", "w", encoding='utf-8') as wf:
        wf.write(answer1)
    ...
    if content:
        output_file_name = f"./auto_add_seq/code/cond/{module_name}_add_cond_code_seq.sv"
